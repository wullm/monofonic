...
int run( config_file& the_config )
{
    ...
    for( const auto& this_species : species_list )
    {
        ...
        // total matter density, including massive neutrinos
        const real_t O_m = the_cosmo_calc->cosmo_param_["Omega_m"];

        // baryon, cdm, and massive neutrino fractions of the total matter density
        ...
        const bool bPerturbedMasses = (bDoBaryons || bDoNeutrinoCorr);
